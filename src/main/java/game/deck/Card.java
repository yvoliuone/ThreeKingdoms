...
import static game.deck.Card.Suit.CLUB;
...
public class Card {
  ...
  Card(int rank, Suit suit, String type) {
    this.suit = suit;
    this.rank = rank;
    this.type = type;
  }
...
//
  ...
  public boolean isBlack() {
    return suit.equals(CLUB) || getSuit().equals(Suit.SPADE);
  }
  ...
  public static Card makeAttack(int rank, Suit suit) {
    return new Card(rank, suit, "attack");
  }

  public static Card makeDodge(int rank, Suit suit) {
    return new Card(rank, suit, "dodge");
  }

  public static Card makePeach(int rank, Suit suit) {
    return new Card(rank, suit, "peach");
  }
